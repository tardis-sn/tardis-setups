...
lbols = np.array([1.85e+41, 1.02e+42, 2.19e+42, 2.62e+42])*u.erg/u.s
...
pool = Pool(4)
final_params = [(5*u.d, lbols[0],  13500.*u.km/u.s), (10*u.d, lbols[1], 12000.*u.km/u.s), (15*u.d, lbols[2], 9500.*u.km/u.s), (20*u.d, lbols[3], 7500.*u.km/u.s)]
